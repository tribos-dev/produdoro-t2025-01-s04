...
public class DataHelper {
    ...
    private static final UUID usuario2 = UUID.fromString("cad68f53-31f5-4075-bf53-672c0f5d81c3");
    ...
    public static Usuario createUsuarioDiferente() {
        return Usuario.builder().email("emaildiferente@email.com").status(StatusUsuario.PAUSA_LONGA).idUsuario(usuario2).build();
    }
    ...
    public static TarefaAlteracaoRequest createEditaTarefa() {
        TarefaAlteracaoRequest tarefaAlteracaoRequest = new TarefaAlteracaoRequest("Tarefa 2");
